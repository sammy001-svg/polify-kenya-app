    ...
    <div className="bg-brand-surface-secondary/50 border-2 border-brand-primary/20 rounded-2xl overflow-hidden animate-in zoom-in-95 duration-700">
      ...
      <div className="bg-brand-primary/5 p-4 border-b border-brand-primary/10 flex items-center justify-between">
         <div className="flex items-center gap-3">
            ...
            <div>
               <h4 className="text-[10px] font-black uppercase tracking-widest text-brand-primary">Draft Bill Generation</h4>
               <p className="text-sm font-black text-brand-text">{bill.bill_number}</p>
            </div>
         </div>
         <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 bg-kenya-gold text-black text-[10px] font-black rounded uppercase">AI Synthesis</span>
            <Button 
              variant="ghost" 
              size="sm" 
      ...
      <div className="p-6 space-y-4">
        <div className="text-center space-y-2 mb-6">
           ...
           <p className="text-[10px] text-brand-text-muted font-bold italic tracking-wide">
              Produced by Bunge AI Legislative Framework Simulation
           </p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-brand-primary/5 rounded-xl border border-brand-primary/10">
                     <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="text-[10px] font-black uppercase text-brand-primary tracking-widest">AI Reasoning</p>
                     </div>
                     <p className="text-xs text-brand-text/70 leading-relaxed italic">
                        The AI analyzed the core idea of &quot;{bill.title}&quot; and synthesized this draft to maximize feasibility while preserving the original citizen intent.
                     </p>
                  </div>
                  ...
                  <div className="p-4 bg-kenya-red/5 rounded-xl border border-kenya-red/10 flex gap-3">
                     ...
                     <div>
                        <p className="text-[10px] font-black uppercase text-kenya-red tracking-widest mb-1">Constitutional Note</p>
      ...
      <div className="p-4 border-t border-border bg-brand-bg/40 flex justify-between items-center">
         ...
         <Button size="sm" className="bg-brand-primary rounded-full text-xs font-bold gap-2 group">
            <BookOpen className="w-4 h-4" /> Export Report <ChevronUp className="w-3 h-3 opacity-0 group-hover:opacity-100 group-hover:-translate-y-0.5 transition-all" />
         </Button>
      </div>
    </div>
  );
