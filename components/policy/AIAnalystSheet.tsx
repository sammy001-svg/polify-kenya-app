        ...
        <div className="p-6 border-b border-white/5 flex items-center justify-between bg-brand-bg/50 glass">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-brand-text-muted uppercase tracking-widest leading-none">
                Legislative Synthesis Engine v4.2
              </p>
            </div>
          </div>
          <button
            ...
            {terminalText.map((text, i) => (
              ...
              >
                ...
                >
                  {text}
                  {i === terminalText.length - 1 && isProcessing && (
                    <span className="inline-block w-2 h-4 bg-kenya-green ml-1 animate-pulse align-middle" />
                  )}
                </span>
              </div>
            ))}
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-2xl bg-brand-surface-secondary border border-white/5 space-y-1">
                  <p className="text-[10px] font-black uppercase text-brand-text-muted tracking-widest">
                    Feasibility
                  </p>
              ...
              <div className="space-y-4">
                <h4 className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-brand-text-muted">
                  <Zap className="w-4 h-4 text-brand-primary" /> Key
                  Recommendations
                </h4>
