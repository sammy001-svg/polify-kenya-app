...
export const DEMO_CHAT = [
  {
    user: "Wanjiku_Ke",
    message: "This is exactly what we needed to hear! Transparency is key.",
    color: "bg-kenya-red",
  },
  {
    user: "Patriot_254",
    message: "Can the Minister clarify on the generated jobs data?",
    color: "bg-kenya-green",
  },
  {
    user: "Civic_Defender",
    message: "Article 35 guarantees us the right to this information.",
    color: "bg-blue-500",
  },
  {
    user: "Youth_Rep",
    message: "We are watching from Eldoret. Keep it up!",
    color: "bg-kenya-gold",
  },
  {
    user: "Policy_Nerd",
    message: "The timeline for implementation seems too short.",
    color: "bg-purple-500",
  },
];
...
export const DEMO_LEARNING: LearningItem[] = [
  // Constitution
  {
    ...
    description:
      "Know your fundamental rights and freedoms as a Kenyan citizen.",
    duration: "10:00",
  ...
  },
  {
    ...
    description:
      "How power was decentralized from the national government to 47 counties.",
    duration: "15:30",
    category: "Constitution",
    progress: 45,
  ...
  // Policy
  {
    ...
    description:
      "An animated breakdown of how tax laws are debated and passed.",
    duration: "08:15",
    category: "Policy",
    progress: 0,
  ...
  },
  {
    ...
    description:
      "A fact-based look at the housing fund structure and projects.",
    duration: "12:00",
    category: "Policy",
    progress: 10,
  ...
  // Parliament
  {
    ...
    description:
      "Key dates for public participation in the national budget process.",
    duration: "09:45",
    category: "Parliament",
    progress: 0,
    thumbnailUrl: "/thumbnails/parliament.png",
...
export const DEMO_FACT_CHECKS: FactCheck[] = [
  {
    ...
    explanation:
      "Strictly 'digital' jobs verified are approx 45,000. The 200k figure likely includes gig economy roles.",
    citations: [
  ...
  },
  {
    ...
    verdict: "True",
    explanation:
      "CAK reports show 3G/4G coverage has reached 96% of the population, with actual usage at 85%.",
    citations: [{ label: "CAK Sector Statistics Q3 2025", url: "#" }],
  },
];
...
export const DEMO_QUIZZES: QuizQuestion[] = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "The Constitution has 264 Articles organized into 18 Chapters.",
    difficulty: "Medium",
  },
  {
    id: 2,
    ...
    correctAnswer: 3,
    explanation:
      "Unlike some countries, Kenya's Parliament cannot be dissolved by the President. It serves its full 5-year term.",
    difficulty: "Hard",
  },
  {
    id: 3,
    question:
      "What percentage of county revenue must be allocated to development?",
    options: [
      "At least 15%",
      "At least 30%",
      "At least 50%",
    ...
    correctAnswer: 1,
    explanation:
      "The Public Finance Management Act requires counties to allocate at least 30% of their budget to development.",
    difficulty: "Hard",
  },
];
...
export const DEMO_SIMULATIONS: SimulationScenario[] = [
  {
    ...
    description:
      "Doctors at the main county hospital have gone on strike demanding salary increases. The strike has entered its second week and patients are suffering.",
    choices: [
      {
        text: "Negotiate immediately and agree to 80% of their demands",
        consequences: { publicTrust: 10, budget: -15, development: -5 },
        outcome:
          "The strike ends quickly. Public praises your swift action, but the treasury is strained and other projects are delayed.",
      },
      {
        text: "Hold firm and wait for doctors to return to work",
        consequences: { publicTrust: -20, budget: 5, development: 0 },
        outcome:
          "The strike drags on for another month. Patient deaths are reported. Your approval rating plummets, though the budget remains intact.",
      },
      {
        text: "Set up a public committee to review the salary structure",
        consequences: { publicTrust: 5, budget: -5, development: 0 },
        outcome:
          "A balanced approach. The strike continues but conversation starts. Public sees you as deliberate, not weak.",
      },
    ],
  },
];
...
export const DEMO_MEMES: PoliticalMeme[] = [
  {
    ...
    context:
      "Reference to government claim of 200k digital jobs created. Official figures show ~45k verified positions, with remainder being gig economy roles.",
  ...
  },
  {
    ...
    context:
      "Citizens joking about prioritization of governor's vehicles over road repairs. County allocated 15M for official cars vs. 8M for road maintenance in Q3 2025.",
  ...
  },
  {
    id: 3,
    caption:
      "When they explain devolution but your county still has no water 😭🚰",
    context:
      "Devolution was meant to bring services closer to people. Despite county funds, many rural areas still lack basic infrastructure.",
  ...
  },
  {
    id: 4,
    caption:
      "Finance Bill: 'We reduce taxes' Also Finance Bill: *introduces 5 new levies*",
    context:
      "Classic misdirection in policy. While headline tax rate dropped 2%, several sector-specific levies were introduced, net effect was tax increase for most SMEs.",
    category: "Parliament Roasts",
  ...
  },
  {
    ...
    context:
      "Parliamentary sessions often stretch due to procedural delays. Average substantive debate time is ~2hrs despite 6hr sessions.",
  ...
  },
  {
    id: 6,
    caption:
      "Affordable Housing Levy hitting different when you're unemployed 💸😂",
    context:
      "The 1.5% housing levy applies to all employed citizens. Youth unemployment at 67% means many targeted beneficiaries can't contribute or benefit.",
    category: "Policy Explainers",
